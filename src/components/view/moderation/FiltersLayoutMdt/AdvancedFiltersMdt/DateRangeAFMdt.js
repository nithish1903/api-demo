...
const DateRangeAFMdt = () => {
  ...
  return (
    <div className='relative'>
        <div onClick={()=>{setOpen(!open)}} className={`${range&&range.length>0&&range[0].startDate?`w-auto`:`w-full`} bg-[#FFFFFF] flex items-center justify-between border-2 border-[#CFD5E1] p-2 rounded-[4px] z-[100]`}>
          <div className='mx-2'>
